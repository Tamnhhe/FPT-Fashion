            ...
            <section class="hero-section ev-common-hero" style="background-image: url(images/common-banner/shape-1.png);"> 
                <div class="container-fluid">
                    <div class="ev-hero-content">
                        <h4>Bạn đã đặt hàng thành công, cảm ơn bạn đã tin tưởng FPT Fashion Men, chúc bạn có 1 ngày tràn ngập niềm vui</h4>
                    <span><a href="${pageContext.request.contextPath}/home">Home ></a> <a href="${pageContext.request.contextPath}/filterproductservlet?category=0&minPrice=${sessionScope.minPrice}&maxPrice=${sessionScope.maxPrice}&orderBy=0">Shop</a></span>
                </div>
            </div>
        </section>
