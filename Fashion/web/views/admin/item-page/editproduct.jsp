<%-- 
    ...
    Created on : Mar 8, 2024, 10:02:17 PM
    Author     : Tamnhhe173108
--%>

<%@page import="model.ProductDetail"%>
<%@page import="java.util.List"%>
<%@page import="dal.ProductDetailDAO"%>
            ...
            <jsp:include page="../../common/admin/leftmainsidebar.jsp"></jsp:include>
                ...
                <jsp:include page="../../common/admin/header.jsp"></jsp:include>
                    ...
                    <div class="ec-content-wrapper">
                        ...
                        <form id="f" action="${pageContext.request.contextPath}/updateproduct" method="get" class="row g-3">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card card-default">
                                        <div class="card-header card-header-border-bottom">
                                            <h2>Edit Product</h2>
                                            <span style="color: green; margin-left: 20px">${requestScope.updateProductSucc}</span>
                                        </div>
                                        ...
                                        <%
                                            ...
                                            for (int i = 0; i < listProductDetail.size(); i++) {
                                                ...
                                                String sizeOption = listProductDetail.get(i).getSize().getSizeOption();
                                                int quantity = listProductDetail.get(i).getQuantity();
                                            ...
                                            request.setAttribute("productTag", productTag);
                                        %>
                                            ...
                                            <div class="row ec-vendor-uploads">
                                                        ...
                                                        <div class="ec-vendor-main-img">
                                                            ...
                                                            <div class="avatar-upload">
                                                                <div class="avatar-edit">
                                                                    <input type="hidden" id="anh0" name="sttEditAnh" value=""/>
                                                                    <input
                                                                        type="file"
                                                                        onclick="sttEdit(${0})"
                                                                        name="image"
                                                            ...
                                                            <div class="thumb-upload-set colo-md-12">
                                                                <c:set var="soLuongAnh" value="${requestScope.product.thumbnails.size()}"/>
                                                                <c:set var="i" value="${1}"/>

                                                                <c:forEach items="${requestScope.product.thumbnails}" var="address">
                                                                    <c:if test="${address != requestScope.product.thumbnails.get(0)}">
                                                                        <input type="hidden" id="anh${i}" name="sttEditAnh" value=""/>
                                                                            ...
                                                                            <div class="thumb-preview ec-preview">
                                                                                <div class="image-thumb-preview">
                                                                                    <img
                                                                                        ...
                                                                                        src="${pageContext.request.contextPath}/${address}"
                                                                                        alt="edit"
                                                                                        />
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <c:forEach begin="${soLuongAnh + 1}" end="${10}" var="address">
                                                                    <div class="thumb-upload">
                                                                        <div class="thumb-edit">
                                                                            <input type="hidden" id="anh${i}" name="sttEditAnh" value=""/>
                                                                            <input
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="ec-vendor-upload-detail">
                                                        <c:set var="editProduct" value="${requestScope.product}"/>
                                                        <div class="col-md-6">
                                                            <label class="form-label">Select Category</label>
                                                            <select name="category" id="Categories" class="form-select">
                                                                <c:forEach items="${sessionScope.categoryAll}" var="category">
                                                                    <option value="${category.categoryId}" ${editProduct != null && category.categoryId == editProduct.category.categoryId ? 'selected' : ''}>${category.categoryName}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div style="margin-top: 30px " class="col-md-6">
                                                            ...
                                                            <select name="supperlier" id="supperlier" class="form-select">
                                                                <c:forEach items="${sessionScope.supperlierAll}" var="supperlier">
                                                                    <option value="${supperlier.supperlierId}" ${editProduct != null && supperlier.supperlierId == editProduct.supperlier.supperlierId ? 'selected' : ''}>${supperlier.company_name}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div style="margin-top: 30px " class="col-md-12">
                                                            ...
                                                            <textarea
                                                                ...
                                                                id="tongHopOption"
                                                                name="optionLuaChon"
                                                                >${requestScope.productTag}</textarea>
                                                        </div>
