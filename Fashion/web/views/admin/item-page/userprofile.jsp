                ...
                <div class="ec-content-wrapper">
                    <div class="content">
                        ...
                        <%
                            ...
                            User account = ud.getUserById(userId);
                                    ...
                                    <div class="profile-content-left profile-left-spacing">
                                        <div class="text-center widget-profile px-0 border-0">
                                            <div class="card-img mx-auto rounded-circle">
                                                <img src="${pageContext.request.contextPath}/${requestScope.account.image}" alt="user image">
                                            </div>
                                            <div class="card-body">
                                                <h4 class="py-2 text-dark">${requestScope.account.fullName}</h4>
                                        ...
                                        <div class="contact-info pt-4">
                                            ...
                                            <p>${requestScope.account.email != null ? requestScope.account.email : 'empty'}</p>
                                            <p class="text-dark font-weight-medium pt-24px mb-2">Phone Number</p>
                                            <p>${requestScope.account.phoneNumber != null ? requestScope.account.phoneNumber : 'empty'}</p>
                                            <p class="text-dark font-weight-medium pt-24px mb-2">Birthday</p>
                                            <p>${requestScope.account.birthDay != null ? requestScope.account.birthDay : 'empty'}</p>
                                            <p class="text-dark font-weight-medium pt-24px mb-2">Address</p>
                                            <p>${requestScope.account.address != null ? requestScope.account.address : 'empty'}</p>
                                            <p class="text-dark font-weight-medium pt-24px mb-2">Created at</p>
                                            <p>${requestScope.account.createdAt != null ? requestScope.account.createdAt : 'empty'}</p>
                                            <p class="text-dark font-weight-medium pt-24px mb-2">updated at</p>
                                            <p>${requestScope.account.updatedAt != null ? requestScope.account.updatedAt : 'empty'}</p>
                                        </div>
