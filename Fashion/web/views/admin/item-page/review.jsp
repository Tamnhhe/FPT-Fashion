                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="responsive-data-table" class="table" style="width:100%">
                                                    ...
                                                    <tbody>
                                                    <c:forEach items="${sessionScope.commentAll}" var="comment">
                                                        <tr>
                                                            <td><img class="tbl-thumb" src="${pageContext.request.contextPath}/${comment.product.thumbnails.get(0)}" alt="product image"/></td>
