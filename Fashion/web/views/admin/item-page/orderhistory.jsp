                                                ...
                                                <tbody>
                                                    <c:forEach items="${ListAllOrderAndOrderDetail}" var="order">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>${order.key.user.email != null ? order.key.user.email : 'empty'}</td>
                                                            <td>${order.value.size()}</td>
                                                            <td>${order.key.totalMoney}&nbsp;VND</td>
                                                            <td>
                                                                <c:if test="${order.key.payment.paymentId == 1}">
                                                                    PAID
                                                                </c:if>
                                                                <c:if test="${order.key.payment.paymentId == 2}">
                                                                    COD
                                                                </c:if>
                                                            </td>
                                                            <td>
