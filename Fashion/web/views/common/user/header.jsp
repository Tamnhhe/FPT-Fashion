        ...
        <div class="container d-flex align-items-center justify-content-between">
            <div class="top-bar-contact d-flex align-items-center">
                <ul class="d-flex align-items-center">
                    <li><a href="#"><i class="fa-solid fa-phone"></i>+84 36999 4876</a></li>
                    <li><a href="mailto: tamnhhe@gmail.com" target="_blank"><i class="fa-regular fa-envelope"></i>tamnhhe@gmail.com</a></li>
                    <li><a href="https://maps.app.goo.gl/YbsfxxbNE8RHA5TH7" target="_blank"><i class="fa-sharp fa-solid fa-location-dot"></i>Locate Our Shop</a></li>
                </ul>
            </div>
...
<!--                                    <div class="sub-menu mega-menu mega-menu-column-4">
                    ...
                    <div class="header-item item-right">
                        <a href="https://www.facebook.com/Tamnh88/"><i class="fa-solid fa-headset"></i>Help & Support</a>
