            ...
            <div class="col-xl-3 col-md-6 col-sm-6 col-12 d-flex ">
                <div class="widgets-item">
                    ...
                    <div class="widgets-contacts">
                        <ul>
                            <li><a href="#" class="d-flex"><i class="fa-solid fa-location-dot"></i><span>Hòa Lạc, Thạch Thất, Hà Nội</span></a></li>
                            <li><a href="#" class="d-flex"><i class="fa-solid fa-envelope"></i> tamnhhe@gmail.com</a></li>
                            <li><a href="#" class="d-flex"><i class="fa-solid fa-phone"></i> +84 36999 4876</a></li>
                        </ul>
                    </div>
            ...
            <div class="row bottom-footer">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex align-items-center justify-content-lg-center justify-content-center pb-3">
                    <div class="footer-bottom-center">
                        <span style="font-size: 20px" style="text-align: center">Copyright 2024 © Thời Trang FPT - All rights reserved. </span>
                    </div>
                </div>
